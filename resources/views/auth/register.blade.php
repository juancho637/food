...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">Ingresa tus datos para registrat tú empresa</p>

        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div class="form-group{{ $errors->has('company') ? ' has-error' : '' }} has-feedback">
                <input type="text" class="form-control" placeholder="Nombre de la empresa" name="company" value="{{ old('company') }}" required autofocus>
                @if ($errors->has('email'))
            ...
            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }} has-feedback">
                <input type="password" class="form-control" placeholder="Confirmación de contraseña" name="password_confirmation" required>
